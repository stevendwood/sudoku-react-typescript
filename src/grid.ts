...
export default class Grid {
    ...
    _columns: Array<Array<Cell>> | undefined;
    grids: Array<Array<Array<Cell>>> | undefined;

    constructor(input = EMPTY) {
        let currentRow: Array<Cell> = [];
        this.rows = [];
        ...
        if (!this._columns) {
            ...
            this.rows.forEach((row) => {
                row.forEach((cell, idx) => {
                    this._columns && this._columns[idx].push(cell);
                });
            });
        }
